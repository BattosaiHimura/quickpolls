...
class UserTableMap extends TableMap
{
     ...
     */
    const COL_MATRICOLA = 'User.matricola';

    /**
     * the column name for the UserType_idUserType field
     */
    const COL_USERTYPE_IDUSERTYPE = 'User.UserType_idUserType';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Iduser', 'Name', 'Surname', 'Matricola', 'UsertypeIdusertype', 'Email', ),
        self::TYPE_CAMELNAME     => array('iduser', 'name', 'surname', 'matricola', 'usertypeIdusertype', 'email', ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_IDUSER, UserTableMap::COL_NAME, UserTableMap::COL_SURNAME, UserTableMap::COL_MATRICOLA, UserTableMap::COL_USERTYPE_IDUSERTYPE, UserTableMap::COL_EMAIL, ),
        self::TYPE_FIELDNAME     => array('idUser', 'name', 'surname', 'matricola', 'UserType_idUserType', 'email', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Iduser' => 0, 'Name' => 1, 'Surname' => 2, 'Matricola' => 3, 'UsertypeIdusertype' => 4, 'Email' => 5, ),
        self::TYPE_CAMELNAME     => array('iduser' => 0, 'name' => 1, 'surname' => 2, 'matricola' => 3, 'usertypeIdusertype' => 4, 'email' => 5, ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_IDUSER => 0, UserTableMap::COL_NAME => 1, UserTableMap::COL_SURNAME => 2, UserTableMap::COL_MATRICOLA => 3, UserTableMap::COL_USERTYPE_IDUSERTYPE => 4, UserTableMap::COL_EMAIL => 5, ),
        self::TYPE_FIELDNAME     => array('idUser' => 0, 'name' => 1, 'surname' => 2, 'matricola' => 3, 'UserType_idUserType' => 4, 'email' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('UserType_idUserType', 'UsertypeIdusertype', 'INTEGER', 'User_type', 'idUserType', true, null, null);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserTableMap::COL_MATRICOLA);
            $criteria->addSelectColumn(UserTableMap::COL_USERTYPE_IDUSERTYPE);
