...
class CommentsTableMap extends TableMap
{
     ...
     */
    const COL_VOTE_ID = 'comments.vote_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'VoteId', 'Comment', ),
        self::TYPE_CAMELNAME     => array('id', 'voteId', 'comment', ),
        self::TYPE_COLNAME       => array(CommentsTableMap::COL_ID, CommentsTableMap::COL_VOTE_ID, CommentsTableMap::COL_COMMENT, ),
        self::TYPE_FIELDNAME     => array('id', 'vote_id', 'comment', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'VoteId' => 1, 'Comment' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'voteId' => 1, 'comment' => 2, ),
        self::TYPE_COLNAME       => array(CommentsTableMap::COL_ID => 0, CommentsTableMap::COL_VOTE_ID => 1, CommentsTableMap::COL_COMMENT => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'vote_id' => 1, 'comment' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('vote_id', 'VoteId', 'INTEGER', 'votes', 'id', true, null, null);
        $this->addColumn('comment', 'Comment', 'VARCHAR', true, 300, null);
    } // initialize()
    ...
    {
        $this->addRelation('Votes', '\\Votes', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':vote_id',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CommentsTableMap::COL_VOTE_ID);
