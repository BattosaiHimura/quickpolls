...
abstract class UserHasPwd implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\UserHasPwdTableMap';
    ...
    /**
     * Initializes internal state of Base\UserHasPwd object.
     */
    ...
    /**
     * Compares this with another <code>UserHasPwd</code> instance.  If
     * <code>obj</code> is an instance of <code>UserHasPwd</code>, delegates to
     * <code>equals(UserHasPwd)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|UserHasPwd The current object, for fluid interface
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 4; // 4 = UserHasPwdTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\UserHasPwd'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildUserHasPwdQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see UserHasPwd::setDeleted()
     * @see UserHasPwd::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildUserHasPwdQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UserHasPwdTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    {
        $pos = UserHasPwdTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['UserHasPwd'][$this->hashCode()])) {
            return '*RECURSION*';
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \UserHasPwd (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \UserHasPwd Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(UserHasPwdTableMap::DEFAULT_STRING_FORMAT);
    }
