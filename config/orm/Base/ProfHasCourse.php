...
abstract class ProfHasCourse implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ProfHasCourseTableMap';
    ...
    /**
     * Initializes internal state of Base\ProfHasCourse object.
     */
    ...
    /**
     * Compares this with another <code>ProfHasCourse</code> instance.  If
     * <code>obj</code> is an instance of <code>ProfHasCourse</code>, delegates to
     * <code>equals(ProfHasCourse)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ProfHasCourse The current object, for fluid interface
     */
    ...
    public function setPresence($v)
    {
        ...
        if ($this->presence !== $v) {
            $this->presence = $v;
            $this->modifiedColumns[ProfHasCourseTableMap::COL_PRESENCE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 4; // 4 = ProfHasCourseTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ProfHasCourse'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildProfHasCourseQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ProfHasCourse::setDeleted()
     * @see ProfHasCourse::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildProfHasCourseQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProfHasCourseTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    {
        $pos = ProfHasCourseTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ProfHasCourse'][$this->hashCode()])) {
            return '*RECURSION*';
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ProfHasCourse (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ProfHasCourse Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(ProfHasCourseTableMap::DEFAULT_STRING_FORMAT);
    }
