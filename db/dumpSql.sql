...
-- -----------------------------------------------------
-- Table `quickPoll`.`User`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `quickPoll`.`User` ;
...
CREATE TABLE IF NOT EXISTS `quickPoll`.`User` (
  ...
  CONSTRAINT `fk_User_UserType`
    ...
    REFERENCES `quickPoll`.`User_type` (`idUserType`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `quickPoll`.`Pwd`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `quickPoll`.`Pwd` ;

CREATE TABLE IF NOT EXISTS `quickPoll`.`Pwd` (
...
CREATE TABLE IF NOT EXISTS `quickPoll`.`User_has_Pwd` (
  ...
  CONSTRAINT `fk_User_has_Pwd_User1`
    ...
    REFERENCES `quickPoll`.`User` (`idUser`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_User_has_Pwd_Pwd1`
    FOREIGN KEY (`Pwd_idPwd`)
    REFERENCES `quickPoll`.`Pwd` (`idPwd`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `quickPoll`.`Course`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `quickPoll`.`Course` ;

CREATE TABLE IF NOT EXISTS `quickPoll`.`Course` (
...
CREATE TABLE IF NOT EXISTS `quickPoll`.`Prof_has_Course` (
  ...
  CONSTRAINT `fk_User_has_Course_Course1`
    ...
    REFERENCES `quickPoll`.`Course` (`idCourse`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `quickPoll`.`Final_vote`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `quickPoll`.`Final_vote` ;

CREATE TABLE IF NOT EXISTS `quickPoll`.`Final_vote` (
  ...
  CONSTRAINT `fk_Final_vote_quality1`
    ...
    REFERENCES `quickPoll`.`Quality` (`idquality`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `quickPoll`.`Argument`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `quickPoll`.`Argument` ;

CREATE TABLE IF NOT EXISTS `quickPoll`.`Argument` (
...
-- -----------------------------------------------------
-- Table `quickPoll`.`DailyLesson`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `quickPoll`.`DailyLesson` ;

CREATE TABLE IF NOT EXISTS `quickPoll`.`DailyLesson` (
  ...
  CONSTRAINT `fk_DailyLesson_Argument1`
    ...
    REFERENCES `quickPoll`.`Argument` (`idArgument` , `Course_idCourse`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `quickPoll`.`DailyLesson_has_User`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `quickPoll`.`DailyLesson_has_User` ;

CREATE TABLE IF NOT EXISTS `quickPoll`.`DailyLesson_has_User` (
  ...
  CONSTRAINT `fk_DailyLesson_has_User_DailyLesson1`
    ...
    REFERENCES `quickPoll`.`DailyLesson` (`idPoll`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
